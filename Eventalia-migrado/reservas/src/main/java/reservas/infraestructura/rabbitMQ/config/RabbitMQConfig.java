...
public class RabbitMQConfig {
  ...
  public MessageConverter messageConverter() {
    ...
    DefaultJackson2JavaTypeMapper typeMapper = getDefaultJackson2JavaTypeMapper();
  ...
  @NotNull
  private static DefaultJackson2JavaTypeMapper getDefaultJackson2JavaTypeMapper() {
